# ⚔️ Warhammer 40,000 "Thought for the Day" Discord Bot ⚔️

[![Warhammer 40K Thought of the Day](https://img.shields.io/badge/Warhammer%2040K-Imperial%20Cogitator-gold.svg)](https://wh40k.lexicanum.com/wiki/Thought_for_the_day)
...
An automated, serverless Discord bot hosted **100% free on GitHub** via **GitHub Actions**. Every 24 hours, the **Imperial Cogitator** transmits a canonical Warhammer 40,000 *"Thought for the Day"* (with official lore citations and calculated Imperial Stardates) directly to your Discord server.
...
```
======================================================================
 === ADEPTUS TELEPATHICA // IMPERIAL COGITATOR TRANSMISSION === 
======================================================================
...
3. Name it **Imperial Cogitator** and click **Copy Webhook URL**.
